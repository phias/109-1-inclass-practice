...
# method 2
# Allen發訊息的時間加上經過的時間長度
LaterTime2 <- NyAllen+15*60
# 轉換到Louis的時區
ParisLouis <- with_tz(LaterTime2, tz="Europe/Paris")
# 結果
ParisLouis
```
...
# 正確答案：sumChNumbersWith0 <- sum(as.integer(fct_chNumbersWith0)) - length(chNumbersWith0)
# 確認輸出內容
sumChNumbersWith0
```
