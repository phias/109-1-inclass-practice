...
```{r ans13}
# G5TimeParsed
G5TimeParsed <- paste0(Game5Time[[1]], " ", "2020", " ", Game5Time[[2]])
class(G5TimeParsed)
```
...
```{r ans14}
# TpeJason
NyAllen <- mdy_hm(G5TimeParsed, tz="America/New_York")
...
LaterTime <- as.POSIXlt.numeric(timelethgth, tz="America/New_York", NyAllen)
LaterTime
...
sumChNumbers <- sum(as.integer(sumChNumbers_facter))
```
